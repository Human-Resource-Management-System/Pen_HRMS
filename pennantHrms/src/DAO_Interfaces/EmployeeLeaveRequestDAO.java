...
public interface EmployeeLeaveRequestDAO {
	...
	/**
	 * 
	 * Saves a job grade leave request.
	 * 
	 * @param request the JobGradeWiseLeaves object representing the leave request
	 *                to be saved
	 */
	...
	/**
	 * 
	 * Updates a job grade leave request based on the provided
	 * JobGradeLeavesOutModel.
	 * 
	 * @param jobGradeLeavesmodel the JobGradeLeavesOutModel containing the updated
